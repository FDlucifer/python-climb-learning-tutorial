...
pygame.display.set_caption("dumb ass car game")
...
def intro_loop():
    ...
    while intro:
        ...
        TextSurf, TextRect = text_objects("fuck ass car game", largetext)
...
def introduction():
    ...
    while introduction:
        ...
        textSurf, textRect = text_objects("this is an can game in witch you need dodge the comming cars", smalltext)
